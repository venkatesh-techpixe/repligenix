const sidebarLayout = `
  ...
  <a href="/youtube-cmr-ui/dashboard/dashboard.html" class="brand-logo d-flex flex-column align-items-center position-relative">
    ...
    <span class="brand-text">
      ...
      <div class="sidebar-menu">
        <ul class="p-0 m-0">
          <!-- Dashboard -->
          <li class="nav-item">
            <a href="../dashboard/dashboard.html" class="nav-link" data-title="Dashboard">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
          ...
          <li class="nav-item">
            <a
              href="../subscription/subscription.html"
              class="nav-link"
          ...
          <li class="nav-item dropdown">
            <a href="../users/users.html" class="nav-link" data-title="Manage Users">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <ul class="dropdown-menu-list">
              <li>
                <a href="../users/users.html" class="submenu-link"
                  >Active Users</a
                >
              </li>
              <li>
          ...
          <!-- Payment Dropdown -->
          <li class="nav-item dropdown">
            <a href="./payments/payments.html" class="nav-link" data-title="Payment">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <ul class="dropdown-menu-list">
              <li>
                <a href="../payments/payments.html " class="submenu-link"
                  >Pending Payments</a
                >
              </li>
              <li>
          ...
          <!-- Support Ticket -->
          <li class="nav-item dropdown">
            <a href="../tickets/tickets.html" class="nav-link" data-title="Support Ticket">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <ul class="dropdown-menu-list">
              <li>
                <a href="../tickets/tickets.html " class="submenu-link"
                  >Pending Ticket</a
                >
              </li>
              <li>
          ...
          <!-- Reports -->
          <li class="nav-item dropdown">
            <a href="../reports/reports.html" class="nav-link" data-title="Report">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <ul class="dropdown-menu-list">
              <li>
                <a href="../reports/reports.html" class="submenu-link"
                  >Subscription History</a
                >
              </li>
              <li><a href="../reports/reports.html" class="submenu-link">Login History</a></li>
              <li><a href="../reports/notification.html" class="submenu-link">Notification History</a></li>
            </ul>
          </li>

          <!-- Subscribers -->
          <li class="nav-item">
            <a href="#" class="nav-link" data-title="Subscribers">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
          ...
          <!-- Extra -->
          <li class="nav-item dropdown">
            <a href="#" class="nav-link" data-title="Extra">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <ul class="dropdown-menu-list">
              <li><a href="../extra/application.html" class="submenu-link">Application</a></li>
              <li><a href="../extra/server.html" class="submenu-link">Server</a></li>
              <li><a href="../extra/cache.html" class="submenu-link">Cache</a></li>
              <li><a href="../extra/update.html" class="submenu-link">Update</a></li>
            </ul>
          </li>
...
const headerLayout = `
      ...
      <div class="header-center flex-grow-1 d-flex justify-content-center">
        <input
          type="text"
          class="search-bar d-none d-md-block"
        ...
        <div class="position-relative">
          ...
          <div id="notificationBox" class="notification-box d-none">
            <div class="notification-header border-bottom mb-2 pb-2">
              ...
              <span class="fs-0-8 text-secondary">You have 8 unread notification</span>
            </div>
